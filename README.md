...
Use [`.env.example`](.env.example) as the reference. Minimum practical setup for the full app:

- `SUPABASE_URL`
- `SUPABASE_ANON_KEY`
- `SUPABASE_AUTH_REDIRECT_URL`
- `OPENAI_API_KEY` for AI-assisted workflow and assistant features
...
AI-assisted workflow and the in-app assistant are login-required in the current product.
